...
const api = axios.create({
  // Use the live Railway backend by default, unless VITE_API_URL is set (for local testing)
  baseURL: import.meta.env.VITE_API_URL || 'https://quantify-production-dc5f.up.railway.app/api/v1',
  headers: {
